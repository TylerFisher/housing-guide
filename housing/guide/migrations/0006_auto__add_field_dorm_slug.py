...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dorm.slug'
        db.add_column(u'guide_dorm', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=51, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dorm.slug'
        db.delete_column(u'guide_dorm', 'slug')
