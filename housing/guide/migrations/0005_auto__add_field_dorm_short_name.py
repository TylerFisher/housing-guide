...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dorm.short_name'
        db.add_column(u'guide_dorm', 'short_name',
                      self.gf('django.db.models.fields.CharField')(default='lol', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dorm.short_name'
        db.delete_column(u'guide_dorm', 'short_name')
