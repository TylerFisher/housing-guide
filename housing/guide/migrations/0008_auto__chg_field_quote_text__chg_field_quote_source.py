...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'guide_quote', 'text', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Quote.source'
        db.alter_column(u'guide_quote', 'source', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Quote.text'
        db.alter_column(u'guide_quote', 'text', self.gf('django.db.models.fields.TextField')(default='This dorm is great!'))

        # Changing field 'Quote.source'
        db.alter_column(u'guide_quote', 'source', self.gf('django.db.models.fields.TextField')(default='some dumb freshman'))
