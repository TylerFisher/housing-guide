...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Quote.dorm'
        db.alter_column(u'guide_quote', 'dorm_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guide.Dorm'], null=True))

    def backwards(self, orm):

        # Changing field 'Quote.dorm'
        db.alter_column(u'guide_quote', 'dorm_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['guide.Dorm']))
