...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SlideshowImage.story'
        db.delete_column(u'guide_slideshowimage', 'story_id')

        # Adding field 'SlideshowImage.dorm'
        db.add_column(u'guide_slideshowimage', 'dorm',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guide.Dorm'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SlideshowImage.story'
        db.add_column(u'guide_slideshowimage', 'story',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guide.Dorm'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'SlideshowImage.dorm'
        db.delete_column(u'guide_slideshowimage', 'dorm_id')
